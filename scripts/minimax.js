...
function drawBoard(origin, cellWidth, boardCanvas) {
	...
	d3.select("#divScoreboard")
				...
				.attr("id", "redScore")
				.style("font-size", "18")
				.html("Fichas rojas: 12")

	d3.select("#divScoreboard")
				.append("div")
				.attr("id", "blackScore")
				.style("font-size", "18")
				.html("Fichas negras: 12");
...
function updateScoreboard() {
	...
	var redLabel = "Fichas rojas: " + pieceCount.red;
	var blackLabel = "Fichas negras: " + pieceCount.black;
	...
	var winnerLabel = "";
	if (winner === player) {
		winnerLabel = "Fichas rojas ganan!!";
	}
	else if (winner === computer) {
		winnerLabel = "Fichas negras ganan!!";
	}
